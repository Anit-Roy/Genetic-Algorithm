...
void printsolution(const char *text)
{
    ...
    printf("\n <popltnsize, irsize, parentcount, childcount, mutnprobab, maxitertns, itertnsdone>=");
    printf(" <%d, %d, %d, %d, %0.3f, %d, %d>\n", popsize, irsize, popsize, childcount, mutprobability, MAXITER, iterations);
}
